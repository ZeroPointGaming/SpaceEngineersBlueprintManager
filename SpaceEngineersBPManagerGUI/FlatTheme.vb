...
#Region " Variables"
    ...
    Friend _FlatColor As Color = Color.FromArgb(23, 26, 27)
...
#End Region
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        With G
            ...
            '-- if ShowText
            If ShowText Then
                .DrawString(Text, Font, New SolidBrush(Color.FromArgb(255, 255, 255)), New Rectangle(16, 16, W, H), NearSF)
            End If
        End With
...
#Region " Colors"
    ...
    Private BGColor As Color = Color.FromArgb(35, 35, 35)
    Private _BaseColor As Color = Color.FromArgb(23, 26, 27)
    Private _ActiveColor As Color = Color.FromArgb(0, 121, 228)
        ...
        With G
            ...
            For i = 0 To TabCount - 1
                ...
                If i = SelectedIndex Then
                    '-- Base
                    .FillRectangle(New SolidBrush(Color.FromArgb(23, 26, 27)), BaseSize)

                    '-- Gradiant
                    '.fill
                    .FillRectangle(New SolidBrush(Color.FromArgb(0, 121, 228)), BaseSize)
